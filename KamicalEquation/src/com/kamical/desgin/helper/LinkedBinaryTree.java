package com.kamical.desgin.helper;
...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>, Iterable<T>
{
                            ...
                            ArrayUnorderedList<T> tempList) 
    {
        ...
        if(node != null)
        {
            tempList.addToRear(node.getElement()); //visit node
            preOrder(node.getLeft(), tempList); //Traverse(left)
            preOrder(node.getRight(), tempList); //Traverse(right)
        }
    }
