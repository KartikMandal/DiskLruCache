...
//https://www.slideshare.net/rapodaca/how-to-balance-any-chemical-equation
//https://arxiv.org/ftp/arxiv/papers/1110/1110.4321.pdf
//http://thatsgeeky.com/wp-content/uploads/2010/09/Balancing-Chemical-Equations-Using-Matrices.pdf
//https://www.youtube.com/watch?v=MRrOglQbL_Y
//https://github.com/kevin-wayne/algs4/blob/master/src/main/java/edu/princeton/cs/algs4/GaussJordanElimination.java
//
public class BalanceEquation {

	   private static final double EPSILON = 1e-8;

	    private int N;      // N-by-N system
	    private double[][] a;     // N-by-N+1 augmented matrix

	    // Gauss-Jordan elimination with partial pivoting
	    public BalanceEquation(double[][] A, double[] b) {
	        N = b.length;
