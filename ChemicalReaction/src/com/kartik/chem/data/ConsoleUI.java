...
import com.kartik.chem.data.EquationCalculator.EquationConditionMass;
import com.kartik.chem.data.RMDatabase.AtomNameNotFoundException;
		...
		while(status != -1) {
			switch (status) {
				...
				case 1: {
					// 输入方程式模式
					System.out.println("\n【输入方程式】  -->1");
					System.out.println("请键入需计算的化学方程式，然后按回车键：  -->1");
					String strInput = null;
					//String strInput = scanner.nextLine();
					strInput="NaOH+H2SO4=Na2SO4+H2O";
					if (strInput == "") {
				...
				case 2: {
					// 方程式平衡检查
					System.out.println("\n【方程式平衡检查】  -->2");
					System.out.println("方程式：  -->2" + equation.toString());
					System.out.print("正在检查配平...  -->2");
					balance = new EquationBalancer(equation);
					if (balance.checkBalance() == false) {
						System.out.println("未配平");
						
						System.out.print("正在使用高斯消元引擎配平方程式... -->2");
