// Note: Jad took from sdk perforce tree
// Note: Must check regardling LGPL license

/**
 * THIS PACKAGE NEEDS SOME WORK IN PARTICULAR REGARDING EXCEPTION/ERROR HANDLING
 * FOR NOW I AM DISABLING THE THROW OF JAVA.LANG.ERROR
 */
...
public class Base64Encode {
    ...
    private static final String FQCN = Base64Encode.class.getName();

    /* RCS version information */
    public static final String RCS_ID = "$Id: //razor/core/platform/src/crypto/com/yodlee/crypto/util/Base64Encode.java#2 $";
